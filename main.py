...
class WebsiteEventController(http.Controller):
    ...
    def registration_confirm(self, event, **post):
        ...
        # start
        registrations = self._process_attendees_form(event, post)
        registrations[0]['team_name'] = post['1-team_name']
        registrations[0]['level'] = post['1-level']
        registrations[0]['gender'] = post['1-gender']
        registrations[0]['player_one'] = post['1-player_one']
        registrations[0]['player_one_phone'] = post['1-player_one_phone']
        registrations[0]['player_one_age'] = post['1-player_one_age']
        registrations[0]['player_one_nationality'] = post['1-player_one_nationality']
        registrations[0]['player_one_email'] = post['1-player_one_email']
        #
        registrations[0]['player_two'] = post['1-player_two']
        registrations[0]['player_two_phone'] = post['1-player_two_phone']
        registrations[0]['player_two_age'] = post['1-player_two_age']
        registrations[0]['player_two_nationality'] = post['1-player_two_nationality']
        registrations[0]['player_two_email'] = post['1-player_two_email']
